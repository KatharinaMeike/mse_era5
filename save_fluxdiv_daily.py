...
timestep = pd.Timestamp('2005-06-03 00:00')
bud = mseb.mse_budget(config_file='mse_budget.ini', timestep=timestep, time_interval='1 day', budget='daily_P137')
