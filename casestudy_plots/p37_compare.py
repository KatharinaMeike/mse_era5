...
ds_daily = xr.open_dataset('/media/katharina/Volume/UChicago/ERA5/mse_output/mse_daily_P37_latlon_2005060300.nc')
...
plt.savefig(plot_path+f'p37_daily_vs_hourly_vint_mean_{plot_timestring}.png',dpi=300,bbox_inches='tight')